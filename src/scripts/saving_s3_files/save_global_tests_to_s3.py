...
def main():
    ...
    #     start_dates.append(
    #         datetime.strftime(
    #             (end_date_date - relativedelta(months=months)), "%Y-%m-%d"
    #         )
    #     )
    ...
    #     save_global_promotion_tests_to_s3(start_date=start_date, end_date=end_date)

    #     print(f"saving features from {start_date}")
    #     save_global_feature_tests_to_s3(start_date=start_date, end_date=end_date)

    #     print(f"saving creative from {start_date}")
    #     save_global_creative_type_tests_to_s3(start_date=start_date, end_date=end_date)
