...
def save_google_descriptive_statistics_to_s3(
    db: Session,
    ...
    if csv_file_name is None:
        csv_file_name = f"google_descriptive_statistics_{end_date}"
    ...
    shop_ids_query = db.query(GoogleDailyPerformance.shop_id).distinct()
