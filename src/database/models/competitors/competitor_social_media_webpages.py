...
from src.database.models.enums.competitor.social_platform import SocialPlatform
...
class CompetitorSocialMediaWebpages(Base):
    ...
    followers_list = relationship(
        "CompetitorSmFollowers", back_populates="webpage", lazy="dynamic"
    )
