...
class Authenticate:
    ...
    def _check_pw(self) -> bool:
        ...
        """
        hashed = self.credentials["usernames"][self.username]["password"]
        if type(hashed) == str:
            hashed = hashed.encode()
        return bcrypt.checkpw(self.password.encode(), hashed)
    ...
    def _register_credentials(
        self, username: str, name: str, password: str, email: str, preauthorization: bool
    ):
        """
